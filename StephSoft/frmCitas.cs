...
namespace StephSoft
{
    public partial class frmCitas : Form
    {
        ...
        private void CargarGridCitasBusqueda()
        {
            try
            {
                if (!this.chkBuscarXFecha.Checked && !this.chkBuscarXCliente.Checked)
                {
        ...
        private void IniciarForm()
        {
            try
            {
                ...
                this.ActiveControl = this.chkBuscarXCliente;
                this.chkBuscarXCliente.Focus();
        ...
        private Cita ObtenerDatosCita(int RowSelected)
        {
            try
            {
                ...
                DateTime.TryParse(Fila.Cells["Fecha"].Value.ToString(), out DateTime fechaCita);
                if (fechaCita != null) DatosAux.FechaCita = fechaCita;
                return DatosAux;
            }
            catch (Exception ex)
            {
        ...
        private void btnAtenderCita_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogError.AddExcFileTxt(ex, "frmCitas ~ btnAtenderCita_Click");
            }
        }
        ...
        private void btnVerCitas_Click(object sender, EventArgs e)
        {
            try
            {
                frmVerReporte Reporte = new frmVerReporte(1, Comun.IDSucursalCaja);
                this.Visible = false;
                Reporte.ShowDialog();
                Reporte.Dispose();
                this.Visible = true;
