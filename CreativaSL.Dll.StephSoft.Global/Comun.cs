...
namespace CreativaSL.Dll.StephSoft.Global
{
    public class Comun
    {
        ...
        private static decimal _PorcentajeComisionTC;

        public static decimal PorcentajeComisionTC
        {
            get { return _PorcentajeComisionTC; }
            set { _PorcentajeComisionTC = value; }
        }

        private static decimal _PorcentajeComisionTD;

        public static decimal PorcentajeComisionTD
        {
            get { return _PorcentajeComisionTD; }
            set { _PorcentajeComisionTD = value; }
        }

        private static string _NamePrinterTicket;

        public static string NamePrinterTicket
        {
            get { return _NamePrinterTicket; }
            set { _NamePrinterTicket = value; }
        }
